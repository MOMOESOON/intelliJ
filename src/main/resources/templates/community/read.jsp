...
<body>
	...
	<div style="width: 80%; margin: auto;max-width: 760px;">
		<ul id="table"> <!-- c:out value 에 들어갈 프로퍼티는 Community 클래스를 보세요. -->
			<li>
				<ul class="row">
					<li>제목</li>
					<li><th:out value="${vo.title}"/></li>
					<li>조회수</li>
					<li><th:out value="${vo.readCount }"/></li>
				</ul>
			</li>
			<li>
				<ul class="row">
					<li>작성자</li>
					<li><th:out value="${vo.writer }"/>
					<span style="font-size: 70%; padding-left: 30px;">(<th:out value="${vo.ip}"/>)</span></li>
					<li>작성날짜</li>
					<li><th:formatDate value="${vo.createdAt }" type="both"/></li>
	...
	<form action="comments" method="post">   <!-- action 은 자바스크립트에서 정합니다. -->
